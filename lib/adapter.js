...
module.exports = (function () {
  ...
  function parseClause(original) {
    ...
    /**
   * This function will parse the where clause based on the datatype of the attributes
   ...
   * Datetime - Reference : https://jsforce.github.io/jsforce/doc/SfDate.html
   * @param {object} data 
   * @param {object} collectionDef Collection definition
   * @returns {object}
  */
  function parseDataByDatatype(data, collectionDef) {
    ...
    const formatters = Object.entries(attributes).reduce((acc, [key, value]) => {
        ...
        return _.mapValues(obj, (item, key) => {
          if (formatters[key]) {
            ...
            if (_.isPlainObject(item)) {
              return _.mapValues(item, (value) => formatters[key](value));
            }
          }
